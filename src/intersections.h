...
// declare the kernel function that performs the Moller-Trumbore ray-triangle intersection test
__host__ __device__ float intersect(const Ray ray,
                                    const glm::vec3 point_0,
                                    const glm::vec3 point_1,
                                    const glm::vec3 point_2);

// declare the kernel function that computes the barycentric weights
