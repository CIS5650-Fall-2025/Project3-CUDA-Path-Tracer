...
bool init()
{
    ...
    window = glfwCreateWindow(width, height, "Nadine's CUDA Path Tracer", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
        return false;
...
void mainLoop()
{
    while (!glfwWindowShouldClose(window))
    {
        ...
        string title = "Nadine's CUDA Path Tracer | " + utilityCore::convertIntToString(iteration) + " Iterations";
